---
title: Volcano 抓取：Spark on Volcano
...
**来源**：<https://volcano.sh/zh-Hans/docs/Ecosystem/SparkOnVolcano>
...
Spark on Kubernetes native支持: 由
Apache Spark社区
和Volcano社区共同维护。
...
从Apache Spark v3.3.0版本及Volcano v1.5.1版本开始，Spark支持Volcano作为自定义调度，查看
链接
了解更多。
...
> 完整与最新内容以官方文档为准：[Spark on Volcano](https://volcano.sh/zh-Hans/docs/Ecosystem/SparkOnVolcano)
