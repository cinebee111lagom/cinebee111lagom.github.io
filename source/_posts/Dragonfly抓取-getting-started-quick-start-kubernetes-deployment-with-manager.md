...
**来源**：<https://d7y.io/docs/next/getting-started/quick-start/kubernetes/deployment-with-manager/>
...
> 完整与最新内容以官方文档为准：[Deployment with Manager](https://d7y.io/docs/next/getting-started/quick-start/kubernetes/deployment-with-manager/)
