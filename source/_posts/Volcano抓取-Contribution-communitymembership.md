...
**来源**：<https://volcano.sh/zh-Hans/docs/Contribution/communitymembership>
...
请注意
这些角色仅适用于Volcano github组织和仓库。当前Volcano还没有正式的角色检视和接收流程。我们将尽快制定该流程.

---

> 完整与最新内容以官方文档为准：[社区成员](https://volcano.sh/zh-Hans/docs/Contribution/communitymembership)
