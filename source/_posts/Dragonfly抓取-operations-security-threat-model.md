---
title: Dragonfly 抓取：Threat Model
...
**来源**：<https://d7y.io/docs/next/operations/security/threat-model/>
...
or misusing the system. Dragonfly community analysts system security based on the
STRIDE model
.
...
: These are attackers who are not part of the Dragonfly system but can interact with
the system to exploit vulnerabilities.

Internal Malicious Attackers
: These are attackers who are part of the Dragonfly system and have access to
...
> 完整与最新内容以官方文档为准：[Threat Model](https://d7y.io/docs/next/operations/security/threat-model/)
