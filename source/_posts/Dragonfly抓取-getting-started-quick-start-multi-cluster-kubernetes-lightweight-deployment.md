...
**来源**：<https://d7y.io/docs/next/getting-started/quick-start/multi-cluster-kubernetes/lightweight-deployment/>
...
own scheduler headless service and
dynconfig.yaml
ConfigMap, and clients only discover the
...
When pull image back-to-source for the first time through Dragonfly, peer uses
cluster-a
's scheduler and seed peer.
It takes
31.714s
to download the
alpine:3.19
...
When pull image hits cache of remote peer, peer uses
cluster-a
's scheduler and seed peer.
It takes
7.304s
...
> 完整与最新内容以官方文档为准：[Lightweight Deployment](https://d7y.io/docs/next/getting-started/quick-start/multi-cluster-kubernetes/lightweight-deployment/)
