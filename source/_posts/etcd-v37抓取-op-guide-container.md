---
title: etcd v3.7 抓取：Run etcd clusters inside containers
date: 2026-09-13 09:33:00
tags:
  - etcd
  - 抓取
  - 文档
...
本文由批量爬取 [etcd v3.7 文档](https://etcd.io/docs/v3.7/op-guide/container/) 自动生成，保留原文结构要点，便于检索与对照。

**来源**：<https://etcd.io/docs/v3.7/op-guide/container/>

---

The following guide shows how to run etcd with Docker using the
static bootstrap process
.

## Docker

In order to expose the etcd API to clients outside of Docker host, use the host IP address of the container. Please see
docker inspect
for more detail on how to get the IP address. Alternatively, specify
--net=host
flag to
docker run
...
To provision a 3 node etcd cluster on bare-metal, the examples in the
baremetal repo
may be useful.
...
> 完整与最新内容以官方文档为准：[Run etcd clusters inside containers](https://etcd.io/docs/v3.7/op-guide/container/)
