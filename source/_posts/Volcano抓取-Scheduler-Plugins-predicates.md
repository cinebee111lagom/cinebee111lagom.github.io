...
**来源**：<https://volcano.sh/zh-Hans/docs/Scheduler/Plugins/predicates>
...
:
nvidia.com/gpu
predicate.resources.nvidia.com/gpu.weight
:
100
```
...
> 完整与最新内容以官方文档为准：[Predicates](https://volcano.sh/zh-Hans/docs/Scheduler/Plugins/predicates)
