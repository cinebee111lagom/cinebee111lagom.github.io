...
**来源**：<https://volcano.sh/zh-Hans/docs/Contribution/VolcanoContribution>
...
请查看
社区角色
了解社区角色的具体情况。随着贡献度的提高，您的角色会逐渐升级。
...
我们将会帮助您在不同的领域做出贡献，如处理 issue、开发特性、修复关键 bug、检视您的代码并合入。如果您对开发流程还有疑问，请查看
Slack Channel
( 注册
点击这里
)，
...
另一个开始贡献的好办法是寻找一个待完善的文档，比如一个缺少超链接或超链接不可用的文档。请查看
贡献者工作流程
下方的工作流程。

#### 围绕一个 Issue 开展工作

当您有意愿针对某个 issue 开展工作时，您可以将这个 issue 分配给自己。在 issue 下回复
/assign
或是
/assign @yourself
即可。机器人将会把这个 issue
...
端到端测试("e2e")：宏观层面的系统一致性测试。Volcano e2e 测试用例位于：
Volcano e2e
。
...
> 完整与最新内容以官方文档为准：[贡献](https://volcano.sh/zh-Hans/docs/Contribution/VolcanoContribution)
