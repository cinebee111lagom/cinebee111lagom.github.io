---
title: etcd v3.7 抓取：Feature Gates
date: 2026-09-13 09:05:00
tags:
  - etcd
  - 抓取
  - 文档
...
本文由批量爬取 [etcd v3.7 文档](https://etcd.io/docs/v3.7/feature-gates/) 自动生成，保留原文结构要点，便于检索与对照。

**来源**：<https://etcd.io/docs/v3.7/feature-gates/>
...
See
feature stages
for an explanation of the stages for a feature.
...
```
feature-gates: ...,StopGRPCServiceOnDefrag
=
true
```
...
is added to
embed.Config
, and should be replacing the experimental fields listed below:
...
Please do try
Beta
features and give feedback on them!
After they exit beta, it may not be practical for us to make more changes.

A
General Availability
(GA) feature is also referred to as a
stable
feature. It means:
...
> 完整与最新内容以官方文档为准：[Feature Gates](https://etcd.io/docs/v3.7/feature-gates/)
