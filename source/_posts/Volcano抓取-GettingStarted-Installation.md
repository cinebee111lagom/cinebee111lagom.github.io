...
**来源**：<https://volcano.sh/zh-Hans/docs/GettingStarted/Installation>
...
在您的集群中下载 Helm，您可以根据以下指南安装 Helm：
安装 Helm
。(仅当您使用helm 模式进行安装时需要)

如果您想使用 Helm 部署 Volcano，请先确认已经在您的集群中安装了
Helm
。
...
一切配置就绪，您可以开始使用 Volcano 部署 AI/ML 和大数据负载了。现在您已经完成了 Volcano 的全部安装，您可以运行如下的例子测试安装的正确性：
样例

---

> 完整与最新内容以官方文档为准：[安装](https://volcano.sh/zh-Hans/docs/GettingStarted/Installation)
