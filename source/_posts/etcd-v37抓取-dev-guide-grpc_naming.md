---
title: etcd v3.7 抓取：gRPC naming and discovery
date: 2026-09-13 09:52:00
tags:
  - etcd
  - 抓取
  - 文档
...
本文由批量爬取 [etcd v3.7 文档](https://etcd.io/docs/v3.7/dev-guide/grpc_naming/) 自动生成，保留原文结构要点，便于检索与对照。

**来源**：<https://etcd.io/docs/v3.7/dev-guide/grpc_naming/>

---

etcd provides a gRPC resolver to support an alternative name system that fetches endpoints from etcd for discovering gRPC services. The underlying mechanism is based on watching updates to keys prefixed with the service name.

Note that this feature is experimental because it depends on the
google.golang.org/grpc/resolver
package, which is still experimental in grpc-go.
...
with JSON-encoded (historically go-grpc
naming.Update
) values as potential service endpoints.
...
New endpoints can be added to the service through
etcdctl
:
...
=
3
etcdctl put foo/bar/my-service/1.2.3.4
'{"Addr":"1.2.3.4"}'
```

The etcd client’s
endpoints.Manager
method can also register new endpoints with a key matching the
Addr
:
...
=
3
etcdctl del foo/bar/my-service/1.2.3.4
```
...
If it’s desired to modify multiple endpoints in a single transaction,
endpoints.Manager
...
> 完整与最新内容以官方文档为准：[gRPC naming and discovery](https://etcd.io/docs/v3.7/dev-guide/grpc_naming/)
