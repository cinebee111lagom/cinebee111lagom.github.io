---
title: KEDA 抓取：Authentication Providers
...
**来源**：<https://keda.sh/docs/2.20/authentication-providers/>
...
> 完整与最新内容以官方文档为准：[Authentication Providers](https://keda.sh/docs/2.20/authentication-providers/)
