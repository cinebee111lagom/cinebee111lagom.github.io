...
**来源**：<https://d7y.io/docs/next/operations/architecture/components/client/>

---

Client is the peer client in P2P network. Use
dfdaemon
to start, or
dfget
...
> 完整与最新内容以官方文档为准：[Client](https://d7y.io/docs/next/operations/architecture/components/client/)
