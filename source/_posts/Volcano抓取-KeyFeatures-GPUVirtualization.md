...
**来源**：<https://volcano.sh/zh-Hans/docs/KeyFeatures/GPUVirtualization>
...
GPU共享模式属于节点级别的配置。Volcano支持异构集群，即集群中可同时包含采用HAMI-core模式的节点和采用Dynamic MIG模式的节点。更多配置及详情，请参阅
...
ConfigMap中。用户可按需自定义此配置。更多详情请参阅
vgpu设备插件YAML文件
。
...
> 完整与最新内容以官方文档为准：[GPU虚拟化](https://volcano.sh/zh-Hans/docs/KeyFeatures/GPUVirtualization)
