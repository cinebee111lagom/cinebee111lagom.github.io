---
title: Volcano 抓取：Kubeflow on Volcano
...
**来源**：<https://volcano.sh/zh-Hans/docs/Ecosystem/KubeflowOnVolcano>
...
1.打开notebook进行TFJob的部署。Open the notebook
mnist/mnist_vanilla_k8s.ipynb
，根据指引来进行分布式Tf Job的部署。

2.添加调度器字段：在
mnist/mnist_vanilla_k8s.ipynb
的Tarining job parameters代码块下的TFJob的配置如下所示，添加
...
> 完整与最新内容以官方文档为准：[Kubeflow on Volcano](https://volcano.sh/zh-Hans/docs/Ecosystem/KubeflowOnVolcano)
