---
title: etcd v3.7 抓取：etcd gateway
date: 2026-09-13 09:36:00
tags:
  - etcd
  - 抓取
  - 文档
...
本文由批量爬取 [etcd v3.7 文档](https://etcd.io/docs/v3.7/op-guide/gateway/) 自动生成，保留原文结构要点，便于检索与对照。

**来源**：<https://etcd.io/docs/v3.7/op-guide/gateway/>
...
=
infra0.example.com:2379,infra1.example.com:2379,infra2.example.com:2379
2016-08-16 11:21:18.867350 I
|
tcpproxy: ready to proxy client requests to
[
...
]
```
...
```
$ etcd gateway start --discovery-srv
=
example.com
2016-08-16 11:21:18.867350 I
|
...
(gateway does not terminate TLS). Note that the gateway does not verify the HTTP schema or inspect the requests, it only forwards requests to the given endpoints.
...
> 完整与最新内容以官方文档为准：[etcd gateway](https://etcd.io/docs/v3.7/op-guide/gateway/)
