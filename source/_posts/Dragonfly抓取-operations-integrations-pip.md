---
title: Dragonfly 抓取：Pip
date: 2026-09-14 09:28:00
tags:
  - Dragonfly
  - 抓取
  - 文档
...
**来源**：<https://d7y.io/docs/next/operations/integrations/pip/>
...
.
Add
files.pythonhosted.org/packages/.*\.(whl|tar.gz|zip)
,
pypi.python.org/.*\.(whl|tar.gz|zip)
and
pypi.org/.*\.(whl|tar.gz|zip)
rules to
...
> 完整与最新内容以官方文档为准：[Pip](https://d7y.io/docs/next/operations/integrations/pip/)
