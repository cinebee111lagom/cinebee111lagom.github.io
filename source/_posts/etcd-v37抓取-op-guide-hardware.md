---
title: etcd v3.7 抓取：Hardware recommendations
date: 2026-09-13 09:38:00
tags:
  - etcd
  - 抓取
  - 文档
...
本文由批量爬取 [etcd v3.7 文档](https://etcd.io/docs/v3.7/op-guide/hardware/) 自动生成，保留原文结构要点，便于检索与对照。

**来源**：<https://etcd.io/docs/v3.7/op-guide/hardware/>
...
Deploy etcd members within a single data center when possible to avoid latency overheads and lessen the possibility of partitioning events. If a failure domain in another data center is required, choose a data center closer to the existing one. Please also read the
tuning
documentation for more information on cross data center deployment.
...
> 完整与最新内容以官方文档为准：[Hardware recommendations](https://etcd.io/docs/v3.7/op-guide/hardware/)
