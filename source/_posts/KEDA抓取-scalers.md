...
**来源**：<https://keda.sh/docs/2.20/scalers/>
...
KEDA
scalers
can both detect if a deployment should be activated or deactivated, and feed custom metrics for a specific event source.

## Currently available scalers for KEDA

---

> 完整与最新内容以官方文档为准：[Scalers](https://keda.sh/docs/2.20/scalers/)
