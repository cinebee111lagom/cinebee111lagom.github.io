---
title: etcd v3.7 抓取：Configuration options
date: 2026-09-13 09:29:00
tags:
  - etcd
  - 抓取
  - 文档
...
本文由批量爬取 [etcd v3.7 文档](https://etcd.io/docs/v3.7/op-guide/configuration/) 自动生成，保留原文结构要点，便于检索与对照。

**来源**：<https://etcd.io/docs/v3.7/op-guide/configuration/>
...
Caution
: If you mix-and-match configuration options, then the following
rules apply.
...
If you provide a
configuration file
all command-line flags and environment variables are
ignored
.

## Command-line flags

Flags are presented below using the format
...
Note
: For details concerning new, updated, and deprecated v3.7 flags,
see
CHANGELOG-3.7.md
.
...
: Several
--experimental-*
flags have been promoted or renamed in v3.7.
...
Note
: flags will be deprecated in v3.6.
...
> 完整与最新内容以官方文档为准：[Configuration options](https://etcd.io/docs/v3.7/op-guide/configuration/)
