...
**来源**：<https://d7y.io/docs/next/reference/configuration/manager/>

---

## Configure Manager YAML File

The default path for the manager yaml configuration file is
/etc/dragonfly/manager.yaml
in linux,
and the default path is
$HOME/.dragonfly/config/manager.yaml
in darwin.
...
> 完整与最新内容以官方文档为准：[Manager](https://d7y.io/docs/next/reference/configuration/manager/)
