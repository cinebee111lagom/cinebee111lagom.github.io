...
**来源**：<https://d7y.io/docs/next/advanced-guides/open-api/task/>
...
If status is
SUCCESS
, it means that the find task is successful.
result.job_states.results.peers
is the address of the task cache.
...
scheduler_cluster_ids
is the
result.job_states.results.scheduler_cluster_id
of the search task.
...
> 完整与最新内容以官方文档为准：[Task](https://d7y.io/docs/next/advanced-guides/open-api/task/)
