...
**来源**：<https://volcano.sh/zh-Hans/docs/Scheduler/Plugins/gang>
...
Gang 插件将不处于
Ready
状态的任务（包括 Binding、Bound、Running、Allocated、Succeed 和 Pipelined 状态）视为具有更高优先级。在尝试驱逐部分 Pod 并回收资源后，它会检查队列中分配的资源是否能满足任务运行
minAvailable
个 Pod 所需的资源。如果满足，Gang 插件将继续进行调度。
...
> 完整与最新内容以官方文档为准：[Gang](https://volcano.sh/zh-Hans/docs/Scheduler/Plugins/gang)
